...
#### Doctor request
def doctors
  response = RestClient.get 'https://api.betterdoctor.com/2016-03-01/doctors?location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&skip=0&limit=200&user_key=3e4679b46d0072502aa1d79b922da235'
  json = JSON.parse response
